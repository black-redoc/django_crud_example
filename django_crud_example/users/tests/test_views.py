...
from django_crud_example.users.models import User
from django_crud_example.users.tests.factories import UserFactory
from django_crud_example.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
